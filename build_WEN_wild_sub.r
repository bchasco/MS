...
sheetNames <- c(
  ...
  #               ,"ChiwRST2023SubsCompHist"
                'Updated2023 ChiwComHist' #This is subyearling
                ,'2023 NasCompHist'       #This is subyearling
                # ,"LWenRST2024YCompHist"
                # ,"NasRST2024YComphist" #Include in Wild Yearling estimate
                # ,"ChiwRST2024YCompHist" #Include in Wild Yearling estimate
                # ,"NasRST2023SubsCompHist"
                # ,"ChiwRST2023SubsCompHist"
...
ch$loc_code <- recode$Code[match(ch$`Event Site Name`[1],recode$`Event.Site.Name`)]
...
save(WENh, file="data/wildFish_sub.rda")
