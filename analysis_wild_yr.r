...
WENh <- WENh %>%
  ...
  mutate(`sp4` = "Chiwawa Nason RST W") %>%
...
WENh <- rbind(WENh, WENtmp)
WENh$sp4 <- factor(WENh$sp4, levels = c("Chiwawa Nason RST W","Chinook Chiwawa and Nason H", "Chinook LNFH", "Coho", "Steelhead"))
